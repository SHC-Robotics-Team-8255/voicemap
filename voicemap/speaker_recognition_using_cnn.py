...
DATASET_ROOT = "../data/LibriSpeech" # os.path.join(os.path.expanduser("~"), "Downloads/16000_pcm_speeches")

# The folders in which we will put the audio samples and the noise samples
AUDIO_SUBFOLDER = "roboticsclub"
...
print(num_val_samples, train_labels, train_audio_paths)
...
for _ in range(SAMPLES_TO_DISPLAY):
    for audios, labels in test_ds.take(1):
        ...
        print(f"Predicted: {class_names[y_pred]}. Was: {class_names[labels]}")
        """print(
            "Speaker:\33{} {}\33[0m\tPredicted:\33{} {}\33[0m".format(
                "[92m" if labels == y_pred else "[91m",
                class_names[labels],
                "[92m" if labels == y_pred else "[91m",
                class_names[y_pred],
            )
        ...
        sd.play(audios, fs)
        sd.wait()
        # display(Audio(audios[index, :], rate=SAMPLING_RATE))
